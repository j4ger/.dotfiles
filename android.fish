...
set -Ua PATH $ANDROID_HOME/bin $ANDROID_SDK_ROOT/platform-tools

# flutter path
set -Ua PATH $ANDROID_SDK_ROOT/flutter/bin

# Android Studio alias
alias astudio='/usr/local/bin/AndroidSDK/android-studio/bin/studio.sh'

# Apktool path
set -Ua PATH $USER_HOME/dev/Apktool

# Android OS development
set -gx USE_CCACHE 1
set -Ux CCACHE_EXEC /usr/bin/ccache
